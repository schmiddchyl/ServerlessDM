...
namespace CreateHealthData
{
    ...
    public class Function
    {
        ...
        /// <returns></returns>
        public async Task FunctionHandler(HealthInput input, ILambdaContext context)
        {
            ...
            await dbContext.SaveAsync<HealthData>(input.HealthData);
            string bucketName = String.Empty;
          
            if (input.HealthData.ItemData.TryGetValue("Bucket", out bucketName))
            {
